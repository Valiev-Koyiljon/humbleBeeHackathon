...
def run_random_forest(train_path, test_path, target_column="total_calls", normalize=False):
    """
    Load data, train Random Forest regression, evaluate and return the model and predictions.
