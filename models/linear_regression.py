...
def run_linear_regression(train_path, test_path, target_column="total_calls", normalize=False):
    """
    Load data, train linear regression, evaluate and return the model and predictions.
